...
export default function KanbanAprovacoes({ userEmail, userFuncao }) {
  ...
  const negociacoesAnalise = useMemo(() => 
    negociacoes.filter(n => {
      ...
      if (!(n.etapa === "enviado_cadastro" || n.status_aprovacao === "reprovado" || n.status_aprovacao === "corrigido" || n.status_aprovacao === "aguardando_termo" || n.status_aprovacao === "aprovado")) return false;
            ...
            <div className="space-y-4">
              <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                ...
                <div className="mt-3 space-y-1">
                  <p className="text-sm font-semibold text-slate-900">{dealParaAtivar.nome_cliente}</p>
                  <p className="text-sm text-slate-700 font-medium">{dealParaAtivar.placa}</p>
                </div>
              </div>
